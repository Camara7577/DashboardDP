...
df = pd.read_csv(r'D:\Users\warleandro.reginaldo\Documents\DEPARTAMENTO PESSOAL - RH 2025\PROGRAMA\PROJETO STREAMLIT\base_funcionarios.csv', delimiter=';')
...
fig1 = px.bar(df_filt, x='Faixa Idade', color='Gênero')
st.plotly_chart(fig1)

st.subheader('Distribuição por Tempo de Casa')
fig2 = px.bar(df_filt, x='Faixa Tempo de Casa', color='Gênero')
